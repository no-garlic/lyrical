...
def add_data(apps, schema_editor):
    ...
    llm.objects.create(display_name="GPT:4o", internal_name="gpt-4o", provider=llm_provider.objects.get(internal_name="openai"), temperature=0.2, max_tokens=1000)
    llm.objects.create(display_name="GPT:4o-mini", internal_name="gpt-4o-mini", provider=llm_provider.objects.get(internal_name="openai"), temperature=0.2, max_tokens=1000)
    llm.objects.create(display_name="Claude:3.5", internal_name="claude-3-5-haiku-latest", provider=llm_provider.objects.get(internal_name="anthropic"), temperature=0.2, max_tokens=1000)
    ...
    llm.objects.create(display_name="Gemma3:12b", internal_name="gemma3:12b", provider=llm_provider.objects.get(internal_name="ollama"), temperature=0.2, max_tokens=1000)
