...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(model_name="user", name="song_hook_custom_request", field=models.TextField(default='')),
        migrations.AddField(model_name="user", name="song_hook_rhyme_with", field=models.CharField(default='', max_length=255)),
        migrations.AddField(model_name="user", name="song_hook_vocalisation_level", field=models.IntegerField(default=None, null=True, blank=True, choices=[(0, 'None'), (1, 'Low'), (2, 'Medium'), (3, 'High')])),
        migrations.AddField(model_name="user", name="song_hook_vocalisation_terms", field=models.CharField(default=None, null=True, blank=True, max_length=255)),
        migrations.AddField(model_name="user", name="song_hook_max_lines", field=models.IntegerField(default=2)),
        migrations.AddField(model_name="user", name="song_hook_average_syllables", field=models.IntegerField(default=None, null=True, blank=True)),
        migrations.CreateModel(
            name="Song",
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[("theme", "Theme"), ("narrative", "Narrative"), ("mood", "Mood"), ("hook", "Hook"), ("intro", "Intro"), ("verse", "Verse"), 
