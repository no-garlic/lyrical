...
class SongGenerator(BaseLLMGenerator):
    """
    generates a song using llm based on user parameters and themes.
    """
...
def api_gen_song(request):
    """
    generate a song using llm based on user parameters and themes.
    
    args:
        request: django http request object with query parameters
        
    returns:
        streaminghttpresponse: llm generated song or json error response
    """
